...
public enum ResultEnum {
    ...
    USER_INVALID_ERROR(10115, "用户不存在"),
    ...
    USER_VERIFICATION_CODE_ERROR(10240, "验证码错误"),
    ...
    HttpRequestMethodNotSupportedException(12035, "请求类型错误！"),
    NumberFormatException(50010, "数据格式转换错误！"),

    //课业管理模块 20000
    //教学资源管理模块 30000
    RESOURCES_DELETED(30001, "资源已被删除"),
    //系统模版资源管理模块 40000
    //通用错误代码 <10000
    ...
    ERROR(500, "该功能出问题了，请截图并联系系统管理员尽快处理！"),
